...
if (process.env.MONGO_URI) {
  mongoose
    ...
    .then(() => console.log("MongoDB connected for RentEase"))
    .catch(error => console.log(`MongoDB unavailable, using local store: ${error.message}`));
} else {
  console.log("MONGO_URI not set, using local JSON store for preview.");
}
